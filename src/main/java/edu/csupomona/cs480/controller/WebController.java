...
*/	
	...
	@RequestMapping(value = "/google5466541ca5013fe1.html", method = RequestMethod.GET)
	String htmlcheck() {
		return "google-site-verification: google5466541ca5013fe1.html";
	}
	...
	/*********** Testing of Google Calendar API's ************/
	private final static Log logger = LogFactory.getLog(WebController.class);
	...
	@RequestMapping(value = "cs480/login/google", method = RequestMethod.GET)
	public RedirectView googleConnectionStatus(HttpServletRequest request) throws Exception {
		return new RedirectView(authorize());
	}

	@RequestMapping(value = "cs480/login/google", method = RequestMethod.GET, params = "code")
